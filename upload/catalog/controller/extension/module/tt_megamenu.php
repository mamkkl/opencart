...
class ControllerExtensionModuleTTmegamenu extends Controller {
    public function index($setting) {
        ...
        $menu = $this->model_templatetrip_tt_megamenu->getMenuById($menu_id);

        if($menu) {
            if($menu['status']) {
				$data['menu_type'] = $menu['menu_type'];
				
                $top_items = $this->model_templatetrip_tt_megamenu->getTopItems($menu_id);
                ...
                foreach ($top_items as $top_item) {
                    ...
                    $sub_items2 = $this->model_templatetrip_tt_megamenu->getSubItems($top_item['menu_item_id'], '2');

                    foreach ($sub_items2 as $sub_item2) {
                        $sub_items_lv3 = array();

                        $sub_items3 = $this->model_templatetrip_tt_megamenu->getSubItems($sub_item2['sub_menu_item_id'], '3');

                        foreach ($sub_items3 as $sub_item3) {
                            $third_title = $this->model_templatetrip_tt_megamenu->getSubItemDescriptionById($sub_item3['sub_menu_item_id']);
                        ...
                        $second_title = $this->model_templatetrip_tt_megamenu->getSubItemDescriptionById($sub_item2['sub_menu_item_id']);
                    ...
                    $top_item_title = $this->model_templatetrip_tt_megamenu->getTopItemDescriptionById($top_item['menu_item_id']);
        ...
        return $this->load->view('extension/module/tt_megamenu', $data);
    }
}