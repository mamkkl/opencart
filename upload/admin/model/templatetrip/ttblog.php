...
class ModelTemplatetripTTBlog extends Model {
	public function createBlogs() {
		$create_tt_blog = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "tt_blog` (`tt_blog_id` int(11) NOT NULL auto_increment, `module_id` int(11) NOT NULL, `status` int(1) NOT NULL default '0', `image` varchar(255) default NULL, `date_added` datetime NOT NULL, `date_modified` datetime NOT NULL, PRIMARY KEY (`tt_blog_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;";
		...
		$create_tt_blog_comment = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "tt_blog_comment` (`tt_blog_comment_id` int(11) NOT NULL auto_increment, `tt_blog_id` int(11) NOT NULL, `approved` int(1) NOT NULL default '0', `author` varchar(64) NOT NULL default '', `email` varchar(96) NOT NULL, `date_added` datetime NOT NULL, PRIMARY KEY (`tt_blog_comment_id`, `tt_blog_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;";
