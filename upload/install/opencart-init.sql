...
INSERT INTO `oc_api_session` VALUES (1,1,'c4ba433b289af40848fed04e1e','::1','2021-08-27 17:40:04','2021-08-27 17:40:04');
...
INSERT INTO `oc_currency` VALUES (2,'HK Dollar','HKD','$','','2',1.00000000,1,'2021-08-28 14:30:46');
...
INSERT INTO `oc_product_attribute` VALUES (43,2,1,'1'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,4,1,'16GB'),(42,3,2,''),(47,2,2,''),(47,2,1,'4'),(47,4,2,'');
...
CREATE TABLE `oc_product_image` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2365 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oc_product_reward` VALUES (546,42,1,100),(550,47,1,300),(549,28,1,400),(329,43,1,600),(339,29,1,0),(343,48,1,0),(335,40,1,0),(547,30,1,200),(331,44,1,700),(333,45,1,800),(337,31,1,0),(425,35,1,0),(345,33,1,0),(347,46,1,0),(545,41,1,0),(351,36,1,0),(353,34,1,0),(355,32,1,0),(521,49,1,1000);
...
CREATE TABLE `oc_seo_url` (
  ...
  KEY `query` (`query`),
  KEY `keyword` (`keyword`)
) ENGINE=MyISAM AUTO_INCREMENT=849 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oc_session` VALUES ('dcbcfe975d20a70c4504a2c247','{\"gcapcha\":true,\"user_id\":\"1\",\"user_token\":\"6pZkEHeE5UAu6FCjF7K8macTwkxrrYTf\",\"language\":\"zh-HK\",\"currency\":\"HKD\"}','2021-08-28 14:55:46');
...
) ENGINE=MyISAM AUTO_INCREMENT=1325 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-08-28 14:45:12
